...
bool check_String:: is_open(char ch){
...
*/
bool check_String::is_close(char ch){
...
//@return true if all the parentheses match
 bool check_String:: is_balanced(const string& expression){
...
char check_String::store_varaibles (const string& expression){
