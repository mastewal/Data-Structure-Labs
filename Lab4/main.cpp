...
int main()
{
    paren_Checker p1; // instantiate paren_Checker Object
...
// Read the file opened (lab4.txt file) line by line until the end of the file
    while (!myFile.eof() ){
    ...
    // call the is_balanced function and test whether expression is balanced or not
         ...
         cout<< p1.store_varaibles(expression)<<endl;
         cout<< "-----------------------------------"<<endl;
    }// the end of while
